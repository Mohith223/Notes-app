...
const Heading = () => {
    // Defining state for displaying NotesTable and NotesCard
        ...
        <div>
            ...
            <div className="max-md:float-right pr-12 float-right mt-6">
                <Link to="/notes/create">
                    <FaSquarePlus
                        className="text-5xl cursor-pointer hover:shadow-outline" />
                </Link>
            </div>
            {/* Display either NotesTable or NotesCard based on the state */}
